...
def prepare_dataset(dataset, processor, batch_size):
    ...
    train_dataset = LibriSpeechDataset(dataset, processor, "train.other.500")  # Updated for other-500
    val_dataset = LibriSpeechDataset(dataset, processor, "validation.other")
